...
- New tracker items get automatic background research that enriches their content with the relevant code, giving worktree dispatches a stronger starting prompt (toggle in tracker settings).
